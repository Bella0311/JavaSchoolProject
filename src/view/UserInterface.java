...
public class UserInterface {
	...
	public void getAllCustomerDetails() {
		...
		// Address details
		// Check if the address only contains numbers and letters. Specialized symbols like -&(%#$^). are not allowed
		System.out.println("\nAddress:");
		address = input.next();
		...
		// Postal code details
		// Prompt visitor to enter a four-digit postal code, and make sure it is four digits
	...
	public void selectProduct(){
		...
		ShoppingCart shoppingCart = new ShoppingCart("name", myProduct.getNumber(), myProduct.getPrice(), myProduct.getType());
		System.out.println("\nYou have chosen product " + myProduct.getType().toString() + " with price " + myProduct.getPrice() + " DKK!");
	...
	public void printReceipt(){
		...
		// Make a random receipt number for the customer. 2000 is the maximum number and the 1 is our minimum 
	...
	public Creditcard getAllCreditCardDetails() {
	...
	public MobilePay getAllMobilepayDetails() {
		System.out.println("\n ================== Pay with Mobilepay ==================\n ");
	...
	public void notSupportedChoice(){
		System.out.println("We are sorry, we do not have this feature yet. We are working on developing the page further :-) ");

	}
	//Method that writes customer details to file
	public void writeCustomerToFile(String first, String last, String add, String post, String dob, String phone, String cpr, String user, String pass){
		String customerDetails = first + ";" + last + ";" + add + ";" + post + ";" + dob + ";" + 
				phone + ";" + cpr + ";" + user + ";" + pass;;
