...
public class ProductDatabase {
	...
	public ProductDatabase() { 
		...
		//int number, double price, String type, String color, String brand, boolean isAvailable, String size
		...
		products.add (new Toy (15, 40, "Ball games","Planet Of Toys Pro Football Soccer Game With Foam Bumper", true, "3"));
		products.add (new Toy (16, 29, "Outdoor toys","Intex Inflatable See Me Sit Pool Ride, Multi Color", true, "3"));
		...
		products.add (new Toy (20, 50, "Ball games","HRS Tournament Rubber Moulded Official Basketball - Size 7", true, "7"));
		products.add (new Toy (21, 50, "Stuffed animal","Flipzon Flashing Dancing Duck with Sounds, Glowing Hands", true, "0"));
	...
	public static void printClothes(){
		System.out.printf("  |  %-2s |  %-8s |  %-10s |  %-14s |  %-15s |  %-12s |\n", "NUMBER", "PRICE", "TYPE", "COLOR", "BRAND", "SIZE");
		// Creating an Object and going through the whole ArrayList for each object in database
