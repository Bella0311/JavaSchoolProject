...
public class ShoppingCart {
	...
	// Method for printing shopping cart to customer with all the products the customer has chosen 
	public static void printShoppingList(){
		if(shoppingCartList.size() > 0) {
			for(int i = 0; i < shoppingCartList.size(); i++) {
				System.out.println("Product number: " + shoppingCartList.get(i).number + " |" + " Type: " + shoppingCartList.get(i).productType + 
