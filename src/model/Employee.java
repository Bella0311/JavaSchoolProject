...
public class Employee  extends User { 
	...
	public Employee (String firstName, String lastName, String cpr, String employeerID, String userNameE, String passwordE) {
	...
	public String toString() {
		return super.toString() + "Employeer ID: " + employeerID + ", first name: " + getFirstName() + ", last name: " + getLastName() + 
				", cpr-number:" + getCpr() +", user name: " + userNameE + ", password: " + passwordE;
	}
}
